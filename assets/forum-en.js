flarum.core.app.translator.addTranslations({
    "core.forum.change_email.confirm_password_placeholder": "Confirm Password",
    "core.forum.change_email.confirmation_message": "We've sent a confirmation email to {email}. If it doesn't arrive soon, check your spam folder.",
    "core.forum.change_email.dismiss_button": "OK",
    "core.forum.change_email.incorrect_password_message": "The password you entered is incorrect.",
    "core.forum.change_email.submit_button": "Save Changes",
    "core.forum.change_email.title": "Change Email",
    ...
    "core.forum.change_password.title": "Change Password",
    ...
    "core.forum.composer_discussion.title": "Start a Discussion",
    ...
    "core.forum.composer_edit.submit_button": "Save Changes",
    "core.forum.composer_edit.view_button": "View",
    "core.forum.composer_reply.body_placeholder": "Write a Reply...",
    ...
    "core.forum.discussion_controls.delete_button": "Delete",
    "core.forum.discussion_controls.delete_confirmation": "Are you sure you want to delete this discussion?",
    "core.forum.discussion_controls.delete_forever_button": "Delete Forever",
    "core.forum.discussion_controls.log_in_to_reply_button": "Log In to Reply",
    "core.forum.discussion_controls.rename_button": "Rename",
    "core.forum.discussion_controls.reply_button": "Reply",
    "core.forum.discussion_controls.restore_button": "Restore",
    ...
    "core.forum.discussion_list.load_more_button": "Load More",
    ...
    "core.forum.forgot_password.dismiss_button": "OK",
    "core.forum.forgot_password.email_placeholder": "Email",
    ...
    "core.forum.header.log_in_link": "Log In",
    "core.forum.header.log_out_button": "Log Out",
    ...
    "core.forum.header.settings_button": "Settings",
    "core.forum.header.sign_up_link": "Sign Up",
    "core.forum.index.all_discussions_link": "All Discussions",
    ...
    "core.forum.index.mark_all_as_read_tooltip": "Mark All as Read",
    "core.forum.index.meta_title_text": "All Discussions",
    "core.forum.index.refresh_tooltip": "Refresh",
    "core.forum.index.start_discussion_button": "Start a Discussion",
    ...
    "core.forum.log_in.password_placeholder": "Password",
    "core.forum.log_in.remember_me_label": "Remember Me",
    "core.forum.log_in.sign_up_text": "Don't have an account? <a>Sign Up<\/a>",
    "core.forum.log_in.submit_button": "Log In",
    "core.forum.log_in.title": "Log In",
    ...
    "core.forum.notifications.mark_all_as_read_tooltip": "Mark All as Read",
    ...
    "core.forum.post_controls.delete_button": "Delete",
    ...
    "core.forum.post_controls.delete_forever_button": "Delete Forever",
    "core.forum.post_controls.edit_button": "Edit",
    ...
    "core.forum.post_stream.load_more_button": "Load More",
    "core.forum.post_stream.reply_placeholder": "Write a Reply...",
    "core.forum.post_stream.time_lapsed_text": "{period} later",
    "core.forum.rename_discussion.submit_button": "Rename",
    ...
    "core.forum.search.users_heading": "Users",
    "core.forum.settings.account_heading": "Account",
    "core.forum.settings.change_email_button": "Change Email",
    "core.forum.settings.change_password_button": "Change Password",
    "core.forum.settings.notifications_heading": "Notifications",
    "core.forum.settings.notify_by_email_heading": "Email",
    ...
    "core.forum.settings.title": "Settings",
    "core.forum.sign_up.dismiss_button": "OK",
    "core.forum.sign_up.email_placeholder": "Email",
    "core.forum.sign_up.log_in_text": "Already have an account? <a>Log In<\/a>",
    "core.forum.sign_up.password_placeholder": "Password",
    "core.forum.sign_up.submit_button": "Sign Up",
    "core.forum.sign_up.title": "Sign Up",
    "core.forum.sign_up.username_placeholder": "Username",
    "core.forum.sign_up.welcome_text": "Welcome, {username}!",
    "core.forum.user.avatar_remove_button": "Remove",
    ...
    "core.forum.user.posts_link": "Posts",
    "core.forum.user.posts_load_more_button": "Load More",
    "core.forum.user.settings_link": "Settings",
    "core.forum.user_controls.button": "Controls",
    "core.forum.user_controls.delete_button": "Delete",
    ...
    "core.forum.user_controls.edit_button": "Edit",
    "core.forum.user_controls.toggle_dropdown_accessible_label": "Toggle user controls dropdown menu",
    "core.forum.user_email_confirmation.alert_message": "We've sent a confirmation email to {email}. If it doesn't arrive soon, check your spam folder.",
    ...
    "core.lib.edit_user.email_heading": "Email",
    "core.lib.edit_user.email_label": "Email",
    "core.lib.edit_user.groups_heading": "Groups",
    "core.lib.edit_user.password_heading": "Password",
    "core.lib.edit_user.password_label": "Password",
    "core.lib.edit_user.set_password_label": "Set new password",
    "core.lib.edit_user.submit_button": "Save Changes",
    "core.lib.edit_user.title": "Edit User",
    "core.lib.edit_user.username_heading": "Username",
    "core.lib.edit_user.username_label": "Username",
    ...
    "core.lib.loading_indicator.accessible_label": "Loading...",
    ...
    "flarum-suspend.forum.suspend_user.submit_button": "Save Changes",
    ...
    "flarum-flags.forum.flag_post.dismiss_button": "OK",
    ...
    "flarum-flags.forum.flag_post.submit_button": "Flag Post",
    "flarum-flags.forum.flag_post.title": "Flag Post",
    ...
    "flarum-flags.forum.flagged_posts.title": "Flagged Posts",
    "flarum-flags.forum.flagged_posts.tooltip": "Flagged Posts",
    ...
    "fof-user-directory.forum.page.refresh_tooltip": "Refresh",
    "fof-user-directory.forum.page.load_more_button": "Load More",
    ...
    "flarum-nicknames.forum.change_nickname.submit_button": "Save Changes",
    "flarum-nicknames.forum.change_nickname.title": "Change Nickname",
    "flarum-nicknames.forum.edit_user.nicknames_heading": "Change Nickname",
    "flarum-nicknames.forum.edit_user.nicknames_text": "Nickname",
    "flarum-nicknames.forum.settings.change_nickname_button": "Change Nickname",
    ...
    "flarum-tags.forum.all_tags.meta_title_text": "Tags",
    ...
    "flarum-subscriptions.forum.badge.ignoring_tooltip": "Ignoring",
    "flarum-subscriptions.forum.discussion_controls.follow_button": "Follow",
    ...
    "flarum-subscriptions.forum.following.meta_title_text": "Following",
    "flarum-subscriptions.forum.index.following_link": "Following",
    ...
    "flarum-subscriptions.forum.sub_controls.follow_button": "Follow",
    "flarum-subscriptions.forum.sub_controls.following_button": "Following",
    "flarum-subscriptions.forum.sub_controls.following_text": "Be notified of all replies.",
    "flarum-subscriptions.forum.sub_controls.ignoring_button": "Ignoring",
    ...
    "flarum-sticky.forum.badge.sticky_tooltip": "Sticky",
    "flarum-sticky.forum.discussion_controls.sticky_button": "Sticky",
    ...
    "flarum-mentions.forum.notifications.others_text": "{count, plural, one {# other} other {# others}}",
    ...
    "flarum-mentions.forum.post.others_text": "{count, plural, one {# other} other {# others}}",
    "flarum-mentions.forum.post.quote_button": "Quote",
    "flarum-mentions.forum.post.reply_link": "Reply",
    "flarum-mentions.forum.post.you_text": "You",
    ...
    "flarum-likes.forum.notifications.others_text": "{count, plural, one {# other} other {# others}}",
    ...
    "flarum-likes.forum.post.others_link": "{count, plural, one {# other} other {# others}}",
    "flarum-likes.forum.post.unlike_link": "Unlike",
    "flarum-likes.forum.post.you_text": "You",
    ...
    "flarum-approval.forum.badge.awaiting_approval_tooltip": "Awaiting approval",
    "flarum-approval.forum.post.awaiting_approval_text": "Awaiting approval",
    ...
    "fof-drafts.forum.dropdown.tooltip": "Drafts",
    ...
    "fof-nightmode.forum.user.settings.options.auto": "Automatic (based on browser or device options)",
    "fof-nightmode.forum.user.settings.options.day": "Day Mode",
    "fof-nightmode.forum.user.settings.options.night": "Night Mode",
...
//# sourceMappingURL=https://forum.cutefishos.com/assets/forum-en.js.map